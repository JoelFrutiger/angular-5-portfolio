...
export class CvService {
  ...
  getWorkExp(){
    return [
      new CVEntry("2014-2018","Noser Young Professinals AG","Anstellung als Systemadministrator / Entwickler, bearbeiten von Supportanfragen, Wartung / Inbetriebnahme von Netzwerken, Planung und Durchführung von Projekten. Seit 2016: Entwicklung und Ausbildung in den Bereichen Java, iOS, Web und Datenbanken."),
