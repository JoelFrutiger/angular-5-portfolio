...
export class ProjectService {
  ...
  getProjects() {
    return [
      ...
      new Project("Cryptocurrency review", "Cryptoreview desc ", [this.angular, this.php],
        "https://cryptreview.com", "/assets/images/project/cryptreview.png"),
      new Project("Manage goals", "Desc", [this.android, this.java, this.nodejs, this.couchbase],
